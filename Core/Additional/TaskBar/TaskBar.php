...
class TaskBar
{
        ...
        try {
            ...
            $str =
              ...
              <li style="float: right">
                <a class="active" href="#" style="font-size: 10px;">
                  <strong>'.
                            ...
                            ' - '. strtoupper(FEnv::get("framework.env")).'
                  </strong>
                   '.((FEnv::isset("app.locale.context"))? '|<span style="color:#7cff0bb3"> LOCALE : '.
                                FEnv::get("app.locale.context").'</span>' : '').'
                </a>
              </li>
            </ul>
    ...
    private static function taskbarArrayTemplate():array
    {
        ...
        try {
            ...
            $options['css_icon'] =
                FEnv::get("host.web.components.libs.framework")."iumio-manager/css/pe-icon-7-stroke.css";
