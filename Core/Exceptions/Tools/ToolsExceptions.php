                ...
                if ($na[1] != $uidie) {
                    ...
                    if (isset($na[11])) {
                        ...
                        array(
                            ...
                            "method" => $na[8],
                            "uri" => $na[9], "referer" => ((isset($na[10]) ? $na[10] : "N/A")),
                            "type_error" => $na[11], "file_error" => ((isset($na[12]) ? $na[12] : "N/A")),
            ...
            if (isset($na[11])) {
                array_push($a,
                    array(
                        ...
                        "code_title" => $na[4], "explain" => $na[5],
                        "solution" => $na[6], "env" => $na[7],
                        "method" => $na[8], "uri" => $na[9],
                        "referer" => ((isset($na[10]) ? $na[10] : "N/A")), "type_error" => $na[11],
                        "file_error" => ((isset($na[12]) ? $na[12] : "N/A")),
                        "line_error" => ((isset($na[13]) ? $na[13] : "N/A"))
                    )
                );
            }
                ...
                array_push($a,
                    array(
                        ...
                        "client_ip" => $na[2], "code" => $na[3],
                        "code_title" => $na[4], "explain" => $na[5],
                        "solution" => ((isset($na[6]) ? $na[6] : "N/A")), "env" => $na[7],
                        "method" => $na[8],
                        "uri" => ((isset($na[9]) ? $na[9] : "N/A")), "referer" => ((isset($na[10]) ? $na[10] : "N/A")),
                    )
                );
            }
