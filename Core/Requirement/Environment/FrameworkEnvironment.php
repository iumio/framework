    ...
    protected static function __setPaths(string $base, string $env, string $current, $isfcm = false)
    {
        ...
        self::$framework_paths =
            [
                ...
                "framework.baseapps" =>  $base."vendor/iumio/framework/BaseApps/",
                "framework.baseapps.apps.file" =>  $base."vendor/iumio/framework/BaseApps/apps.json",
                "framework.vendor_iumio" =>  $base."vendor/iumio/framework/",
                "framework.fcm" =>  $base."vendor/iumio/framework/Core/Additional/Manager/",
                "framework.additional" =>  $base."vendor/iumio/framework/Core/Additional/",
                ...
                "framework.exceptions" =>  $base."vendor/iumio/framework/Core/Exceptions/Server/",
                "framework.exceptions_view" =>  $base."vendor/iumio/framework/Core/Exception/Server/views/",
                ...
                "baseapp.front" =>  $base."vendor/iumio/framework/BaseApps/%app_name%/Front/",
                "baseapp.master" =>  $base."vendor/iumio/framework/BaseApps/%app_name%/Masters/",
                "baseapp.routing" =>  $base."vendor/iumio/framework/BaseApps/%app_name%/Routing/",
                "baseapp.views" =>  $base."vendor/iumio/framework/BaseApps/%app_name%/Front/views/",
                "baseapp.resources" =>  $base."vendor/iumio/framework/BaseApps/%app_name%/Front/Resources/",
            ];
